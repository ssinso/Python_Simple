...
# Python     snake_case   snake_nase   PascalCase

# 9. 동적 출력
print("="*200)
student_num = 20233064
student_name = "Cherry"
# 출력 예: "조선대학교 20233064, cherry 입니다"
print("조선대학교 20233064, cherry 입니다") # 하드 코딩 지양
# 1. format()
